...
class Ui_MainWindow(object):
	...
	"color: rgb(255, 255, 255);")
        ...
        self.MainRawdataShowtableWidget.setGeometry(QtCore.QRect(42, 0, 540, 430))
        ...
        for i in range(64):
            ...
            if i // 8 == 1 or i // 8 == 3 or i // 8 == 5 or i // 8 == 7:
                m.setGeometry(QtCore.QRect(20 + 40 * (i % 16), 40 + 22 * (i // 16), 35, 20))
            else:
                m.setGeometry(QtCore.QRect(0 + 40 * (i % 16), 40 + 22 * (i // 16), 35, 20))
            font = QtGui.QFont()
            font.setPointSize(11)
            m.setFont(font)
            m.setStyleSheet("")
