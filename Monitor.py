...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(110, 0, 811, 821))
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(0, 0, 80, 411))
        ...
        self.verticalLayout_2.addWidget(self.rawdataRead)
        ...
        self.verticalLayout_2.addWidget(self.radioDC)
        ...
        self.verticalLayout_2.addWidget(self.radioIIR)
        ...
        self.verticalLayout_2.addWidget(self.radioTmp)
        ...
        self.verticalLayout_2.addWidget(self.textEditDiag)
        ...
        self.verticalLayout_2.addWidget(self.sram)
        ...
        self.verticalLayout_2.addWidget(self.recalled)
        ...
        self.tableRawWidget = QtWidgets.QTableWidget(self.TabRawdataShow)
        self.tableRawWidget.setGeometry(QtCore.QRect(80, 0, 601, 800))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(40)
        self.tableRawWidget.setFont(font)
        self.tableRawWidget.setRowCount(33)
        self.tableRawWidget.setColumnCount(19)
        self.tableRawWidget.setObjectName("tableRawWidget")
        self.tableRawWidget.horizontalHeader().setVisible(False)
        self.tableRawWidget.horizontalHeader().setDefaultSectionSize(30)
        self.tableRawWidget.horizontalHeader().setMinimumSectionSize(26)
        self.tableRawWidget.verticalHeader().setVisible(False)
        self.tableRawWidget.verticalHeader().setDefaultSectionSize(10)
        # self.tableRawWidget.verticalHeader().setMinimumSectionSize(50)
        self.tableRawWidget.verticalHeader().setSortIndicatorShown(False)
        self.tableRawWidget.verticalHeader().setStretchLastSection(False)
        self.tableWidget = QtWidgets.QTableWidget(self.TabRawdataShow)
        self.tableWidget.setGeometry(QtCore.QRect(690, 0, 106, 565))
        ...
        self.rawdataShowText.setGeometry(QtCore.QRect(0, 44, 799, 419))
        self.rawdataShowText.setObjectName("rawdataShowText")
        self.horizontalLayoutWidget_3 = QtWidgets.QWidget(self.tab)
        self.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(0, 0, 364, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.LeftMainWindow.setItemText(self.LeftMainWindow.indexOf(self.pageDisplay),
        ...
        self.LeftMainWindow.setItemText(self.LeftMainWindow.indexOf(self.pageOptions),
        ...
        self.tableRawWidget.setSortingEnabled(False)
        self.TabMainWindow.setTabText(self.TabMainWindow.indexOf(self.TabRawdataShow),
                          _translate("MainWindow", "Rawdata"))
        ...
        self.TabMainWindow.setTabText(self.TabMainWindow.indexOf(self.TabRWRegister),
                          _translate("MainWindow", "R/W register"))
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout.addWidget(self.LeftMainWindow)
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(110, 0, 751, 491))
        self.horizontalLayoutWidget.setObjectName("horizontalLayoutWidget")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget)
        self.horizontalLayout.setSizeConstraint(QtWidgets.QLayout.SetMaximumSize)
        self.horizontalLayout.setContentsMargins(0, 3, 0, 0)
        ...
        self.tab.setObjectName("tab")
        self.rawdataShowText = QtWidgets.QTextBrowser(self.tab)
        self.rawdataShowText.setGeometry(QtCore.QRect(0, 44, 741, 411))
        self.rawdataShowText.setObjectName("rawdataShowText")
        self.horizontalLayoutWidget_3 = QtWidgets.QWidget(self.tab)
        ...
        self.horizontalLayout_2.addWidget(self.textEditKmsg)
        self.getevent = QtWidgets.QPushButton(self.horizontalLayoutWidget_3)
        self.getevent.setMinimumSize(QtCore.QSize(70, 0))
        self.getevent.setMaximumSize(QtCore.QSize(70, 30))
        self.getevent.setStyleSheet("background-color: rgb(255, 170, 0);")
        self.getevent.setObjectName("getevent")
        self.horizontalLayout_2.addWidget(self.getevent)
        ...
        self.textEditReadRegAddr.setObjectName("textEditReadRegAddr")
        self.readRegValShowText = QtWidgets.QTextBrowser(self.TabRWRegister)
        self.readRegValShowText.setGeometry(QtCore.QRect(160, 5, 581, 260))
        self.readRegValShowText.setObjectName("readRegValShowText")
        self.textEditWriteVal3 = QtWidgets.QTextEdit(self.TabRWRegister)
        self.textEditWriteVal3.setGeometry(QtCore.QRect(320, 390, 150, 30))
        self.textEditWriteVal3.setMaximumSize(QtCore.QSize(150, 30))
    ...
    def rawdataSetToPageFunc(self):
        pass
        print("clicked")
        tmp = '1233'
        a = QTableWidgetItem(tmp)
        self.tableRawWidget.setItem(1, 1, a)

        col = self.tableRawWidget.columnCount()
        row = self.tableRawWidget.rowCount()
        print(col)
        print(row)
    ...
    def writeRegister(self, reg_address, write_value):
        ...
        if len(reg_address) == 8 and len(write_value) != 0:
            cmd = self.echoWriteRegister % (reg_address, write_value)
            adb.shell(cmd, "SHELL")
