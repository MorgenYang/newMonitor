...
"color: rgb(255, 255, 255);")
        ...
        self.verticalLayout.addWidget(self.LeftMainWindow)
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(110, 0, 811, 661))
        self.horizontalLayoutWidget.setObjectName("horizontalLayoutWidget")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget)
        self.horizontalLayout.setSizeConstraint(QtWidgets.QLayout.SetMaximumSize)
        self.horizontalLayout.setContentsMargins(0, 3, 0, 0)
        ...
        self.tableRawWidget.setGeometry(QtCore.QRect(80, 0, 601, 621))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.tableRawWidget.horizontalHeader().setDefaultSectionSize(25)
        self.tableRawWidget.horizontalHeader().setMinimumSectionSize(28)
        self.tableRawWidget.verticalHeader().setVisible(False)
        self.tableRawWidget.verticalHeader().setDefaultSectionSize(17)
        self.tableRawWidget.verticalHeader().setMinimumSectionSize(17)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.TabMainWindow.setTabText(self.TabMainWindow.indexOf(self.TabRawdataShow), _translate("MainWindow", "Rawdata"))
