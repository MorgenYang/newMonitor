...
class Ui_RawdataWindow(object):
    ...
    def hintMsg(self):
        ...
        self.log.setToolTip("You need set data type first<br/>and <b>stop read rawdata</b>, then start log")
        self.radioDC.setToolTip("Set 2 to diag")
        self.radioIIR.setToolTip("Set 1 to diag")
        self.radioTmp.setToolTip("You need set type <b>first</b><br/>, then click to be effect")
    ...
    def logFunc(self):
        ...
        log = Thread(target=self.logThread, args=(Times, ))
        log.start()
