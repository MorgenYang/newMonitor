...
"background-color: rgb(255, 170, 0);")
        ...
        self.checkChannel = QtWidgets.QPushButton(self.displayGroupBox)
        self.checkChannel.setGeometry(QtCore.QRect(360, 15, 60, 30))
        self.checkChannel.setMaximumSize(QtCore.QSize(100, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.checkChannel.setFont(font)
        self.checkChannel.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.checkChannel.setToolTip("")
        self.checkChannel.setStyleSheet("color: rgb(255, 255, 255);\n"
"background-color: rgb(255, 0, 0);")
        self.checkChannel.setObjectName("checkChannel")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkChannel.setText(_translate("MainWindow", "Check"))
